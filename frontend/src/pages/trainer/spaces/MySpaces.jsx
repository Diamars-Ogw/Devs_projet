  ...
  return (
    <div className="space-y-6 animate-slideUp">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Gérer vos cours et espaces d'enseignement</p>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">{space.promotion}</p>
                </div>
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${space.color} flex items-center justify-center shadow-lg`}>
              ...
              <div className="flex items-center gap-6 py-4 border-t border-b border-gray-100">
                <div className="flex items-center gap-2 text-purple-600 bg-purple-50 px-4 py-2 rounded-lg">
                  ...
                  <div>
                    <p className="text-2xl font-bold">{space.students}</p>
                ...
                <div className="flex items-center gap-2 text-blue-600 bg-blue-50 px-4 py-2 rounded-lg">
                  ...
                  <div>
                    <p className="text-2xl font-bold">{space.works}</p>
              ...
              {/* Action Button */}
              <Link to={`/trainer/spaces/${space.id}`}>
                <Button
                  variant="outline"
